...
wxTreeItemId CatalogDataTreeCtrl::AddChild( wxTreeItemId parent, XMLElement* child )
{
...
wxArrayPtrVoid* CatalogDataTreeCtrl::MakeParentList( XMLElement* catalogData,
...
void CatalogDataTreeCtrl::StructureStamp( XMLElement* catalogData )
{
...
void CatalogDataTreeCtrl::StructureCatalogData( XMLElement* catalogData,
    FormatType parentType,
...
bool CatalogDataTreeCtrl::IsElement( wxTreeItemId item, XMLElement* ele )
{
...
wxTreeItemId CatalogDataTreeCtrl::FindTreeItemID( XMLElement* ele, wxTreeItemId id )
...
wxTreeItemId CatalogDataTreeCtrl::FindTreeItemID( XMLElement* ele )
{
