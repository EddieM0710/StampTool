...
#ifndef CatalogDataTreeCtrl_H
#define CatalogDataTreeCtrl_H
...
class CatalogDataTreeItemData : public wxTreeItemData
{
  public:
     ...
     * @param   ele :
     **************************************************/
    CatalogDataTreeItemData( CatalogNodeType type, const wxString desc,
                       wxXmlNode* ele = 0 )
    {
        m_type = type;
        m_desc = desc;
     ...
     * @param   type :
     **************************************************/
    void SetType( CatalogNodeType type ) { m_type = type; };

    /**
     *
     * @return {CatalogNodeType}   :
     **************************************************/
    CatalogNodeType GetType( ) { return m_type; };

  private:
    wxXmlNode* m_element;
    wxString m_desc;
    CatalogNodeType m_type;
};
 ...
 * 
 **************************************************/
class CatalogDataTreeCtrl : public wxTreeCtrl
{
    //    DECLARE_DYNAMIC_CLASS( CatalogDataTreeCtrl )
    //    DECLARE_EVENT_TABLE()
   ...
   **************************************************/
    ...
    /**
     * CatalogDataTreeCtrl Constructor
     *
     * @param   parent :
     * @param   id    :
     * @param   pos      :
     ...
     * @param   style       :
     **************************************************/
    CatalogDataTreeCtrl( wxWindow* parent, const wxWindowID id, const wxPoint& pos,
     ...
     * 
     **************************************************/
    virtual ~CatalogDataTreeCtrl( void ) {}
