...
#ifndef StampTreeCtrl_H
#define StampTreeCtrl_H
 ...
 *
 **************************************************/
class StampTreeItemData : public wxTreeItemData
{
  public:
    /**
     * @brief StampTreeItemData Constructor
     *
     * @param   type    :
     * @param   desc    :
     * @param   ele :
     **************************************************/
    StampTreeItemData( NodeType type, const wxString desc,
                       XMLElement* ele = 0 )
    {
        m_type = type;
        m_desc = desc;
 ...
 * 
 **************************************************/
class StampTreeCtrl : public wxTreeCtrl
{
    //    DECLARE_DYNAMIC_CLASS( StampTreeCtrl )
    //    DECLARE_EVENT_TABLE()
   ...
   **************************************************/
     ...
     * @param   style       :
     **************************************************/
    StampTreeCtrl( wxWindow* parent, const wxWindowID id, const wxPoint& pos,
   ...
   **************************************************/
    ...
    wxDECLARE_DYNAMIC_CLASS( StampTreeCtrl );
