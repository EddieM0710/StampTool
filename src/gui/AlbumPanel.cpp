...
wxPanel* AlbumPanel::CreateAlbumImageLayoutPanel( wxWindow* parent )
{
    ...
    m_zoomSlider =
        new wxSlider( albumImageLayoutPanel, ID_ALBUMZOOMSLIDER, 70, 10, 200, wxDefaultPosition, 
...
void AlbumPanel::NewDesign( )
{
    ...
    wxFileDialog fileDialog( this, "Create Album file", path, _( "unnamed.alb" ), 
    ...
    designFile.MakeRelativeTo( path );
