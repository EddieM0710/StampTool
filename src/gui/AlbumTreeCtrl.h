...
public:
    ...
    Layout::AlbumNode* GetStampNode(wxTreeItemId itemID);
    ...
    **************************************************/
    ...
    void AddPage( Layout::AlbumNode* node );
    Layout::Stamp* AddStamp( Layout::AlbumNode* node );
    void AddRow( Layout::AlbumNode* node );
    void AddCol( Layout::AlbumNode* node );
