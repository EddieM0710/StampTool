...
////@begin CatalogPanel content construction
    ...
    m_listTree = new CatalogTreeCtrl( itemPanel1, CatalogDataTree_Ctrl, wxDefaultPosition, wxDefaultSize, wxTR_HAS_BUTTONS |wxTR_FULL_ROW_HIGHLIGHT|wxTR_SINGLE|wxSUNKEN_BORDER|wxTR_DEFAULT_STYLE );
