...
EVT_TREE_BEGIN_DRAG( CatalogDataTree_Ctrl, CatalogTreeCtrl::OnBeginDrag )
EVT_TREE_END_DRAG( CatalogDataTree_Ctrl, CatalogTreeCtrl::OnEndDrag )
EVT_TREE_SEL_CHANGED( CatalogDataTree_Ctrl, CatalogTreeCtrl::OnSelChanged )
EVT_TREE_STATE_IMAGE_CLICK( CatalogDataTree_Ctrl, CatalogTreeCtrl::OnItemStateClick )
EVT_CONTEXT_MENU( CatalogTreeCtrl::OnContextMenu )
// EVT_TREE_ITEM_MENU is the preferred event for creating context menus
// on a tree control, because it includes the point of the click or item,
// meaning that no additional placement calculations are required.
EVT_TREE_ITEM_MENU( CatalogDataTree_Ctrl, CatalogTreeCtrl::OnItemMenu )
EVT_TREE_ITEM_RIGHT_CLICK( CatalogDataTree_Ctrl, CatalogTreeCtrl::OnItemRClick )
