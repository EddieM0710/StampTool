...
////@begin DefinePeriodsDialog event table entries
...
////@end DefinePeriodsDialog event table entries
...
{
////@begin DefinePeriodsDialog creation
    ...
    Centre();
////@end DefinePeriodsDialog creation
    return true;
}
...
DefinePeriodsDialog::~DefinePeriodsDialog()
{
////@begin DefinePeriodsDialog destruction
////@end DefinePeriodsDialog destruction
}
...
{
////@begin DefinePeriodsDialog member initialisation
    m_antiqueTextBox = NULL;
    m_AntiqueYear = NULL;
    m_classicTextBox = NULL;
    m_modernTextBox = NULL;
    m_modernYear = NULL;
////@end DefinePeriodsDialog member initialisation
}
...
{    
////@begin DefinePeriodsDialog content construction
    // Generated by DialogBlocks, Wed 12 Jan 2022 12:57:31 CST (unregistered)
...
////@end DefinePeriodsDialog content construction
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_ANTIQUE in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_ANTIQUE in DefinePeriodsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_ANTIQUEYEAR in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_ANTIQUEYEAR in DefinePeriodsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_CLASSIC in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_CLASSIC in DefinePeriodsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_MODERN in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_MODERN in DefinePeriodsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_MODERNYEAR in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_MODERNYEAR in DefinePeriodsDialog. 
}
...
{
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_CANCEL in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_CANCEL in DefinePeriodsDialog. 
}
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_OK in DefinePeriodsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_OK in DefinePeriodsDialog. 
}
...
{
    // Bitmap retrieval
////@begin DefinePeriodsDialog bitmap retrieval
    wxUnusedVar(name);
    return wxNullBitmap;
////@end DefinePeriodsDialog bitmap retrieval
}
...
{
    // Icon retrieval
////@begin DefinePeriodsDialog icon retrieval
    wxUnusedVar(name);
    return wxNullIcon;
////@end DefinePeriodsDialog icon retrieval
}
