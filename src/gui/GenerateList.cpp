...
{ 
    UpdateGrid( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_WRITEBUTTON in GenerateList.
...
{ 
//// wxEVT_COMMAND_TEXT_UPDATED event handler for ID_FILENAMETEXTCTRL in GenerateList.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_TEXT_UPDATED event handler for ID_FILENAMETEXTCTRL in GenerateList. 
}
...
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_SETLISTPREFSBUTTON in GenerateList.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_SETLISTPREFSBUTTON in GenerateList. 
}
