...
{ 
    // Bitmap retrieval
//// GenerateListSettings bitmap retrieval
    wxUnusedVar( name );
    return wxNullBitmap;
//// GenerateListSettings bitmap retrieval
}
...
{ 
    // Icon retrieval
//// GenerateListSettings icon retrieval
    wxUnusedVar( name );
    return wxNullIcon;
//// GenerateListSettings icon retrieval
}
...
{ 
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_STATUSALLBUTTON in GenerateListSettings.
...
{ 
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for IDSTATUSCLEARBUTTON in GenerateListSettings.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for IDSTATUSCLEARBUTTON in GenerateListSettings. 
}
...
{ 
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_EMISSIONALLBUTTON in GenerateListSettings.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_EMISSIONALLBUTTON in GenerateListSettings. 
}
...
{ 
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_EMISSIONCLEARBUTTON in GenerateListSettings.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_EMISSIONCLEARBUTTON in GenerateListSettings. 
}
...
{ 
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_FORMATCLEARBUTTON in GenerateListSettings.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_FORMATCLEARBUTTON in GenerateListSettings. 
}
...
{ 
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_CLEARYEARRANGEBUTTON in GenerateListSettings.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_CLEARYEARRANGEBUTTON in GenerateListSettings. 
}
...
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_OK in GenerateListSettings.
    // Before editing this code, remove the block markers.
    event.Skip( );
//// wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_OK in GenerateListSettings. 
}
