...
#define ID_SCORETEXTBOX ID_MISCELLANEOUSDATA+1
#define ID_ACCURACYTEXTBOX ID_MISCELLANEOUSDATA+2
#define ID_LINKTEXTBOX ID_MISCELLANEOUSDATA+3
#define ID_MYSTICBUTTON ID_MISCELLANEOUSDATA+4
#define ID_COLNECTBUTTON ID_MISCELLANEOUSDATA+5
