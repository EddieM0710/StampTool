...
// NewStampDialog content construction
    // Generated by DialogBlocks, Fri 03 Jun 2022 19:20:32 CDT (unregistered)
...
// wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_CANCEL in NewStampDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_CANCEL in NewStampDialog. 
}
...
// wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_OK in NewStampDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_BUTTON_CLICKED event handler for wxID_OK in NewStampDialog. 
}
