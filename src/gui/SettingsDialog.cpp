...
////@begin SettingsDialog event table entries
    ...
    EVT_TEXT( ID_WORKINGDIRECTORYTEXTBOX, SettingsDialog::OnWorkingdirectorytextboxTextUpdated )
...
////@begin SettingsDialog content construction
    // Generated by DialogBlocks, Wed 12 Jan 2022 10:41:55 CST (unregistered)
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_IMAGEDIRECTORTEXTBOX in SettingsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_IMAGEDIRECTORTEXTBOX in SettingsDialog. 
}
...
void SettingsDialog::OnWorkingdirectorytextboxTextUpdated( wxCommandEvent& event )
{

    ////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_WORKINGDIRECTORYTEXTBOX in SettingsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_WORKINGDIRECTORYTEXTBOX in SettingsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_COUNTRYTEXTBOX in SettingsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_COUNTRYTEXTBOX in SettingsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_CATALOGTEXTBOX in SettingsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_CATALOGTEXTBOX in SettingsDialog. 
}
...
////@begin wxEVT_COMMAND_CHECKBOX_CLICKED event handler for ID_OPENLASTCHECKBOX in SettingsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_CHECKBOX_CLICKED event handler for ID_OPENLASTCHECKBOX in SettingsDialog. 
}
...
////@begin wxEVT_COMMAND_TEXT_UPDATED event handler for ID_RECENTSIZETEXTCTRL in SettingsDialog.
    // Before editing this code, remove the block markers.
    event.Skip();
////@end wxEVT_COMMAND_TEXT_UPDATED event handler for ID_RECENTSIZETEXTCTRL in SettingsDialog. 
}
