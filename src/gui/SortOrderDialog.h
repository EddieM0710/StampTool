...
#define ID_SORTORDERTEXTCTRL ID_SORTORDERDIALOG+1
#define ID_CHOICE ID_SORTORDERDIALOG+2
#define ID_CHOICE1 ID_SORTORDERDIALOG+3
#define ID_CHOICE2 ID_SORTORDERDIALOG+4
#define ID_CHOICE3 ID_SORTORDERDIALOG+5
#define ID_CHOICE4 ID_SORTORDERDIALOG+6
